...
IMPORTANTE - features reales del modelo (confirmadas con model.feature_names_in_):
...
FEATURE_COLS = [
    ...
    "dif_deporvillage_pct", "mes_num", "trimestre", "dia_del_mes",
]
...
def cargar_datos():
    ...
    # Derivar columnas temporales que el modelo necesita y que no vienen en el CSV
    ...
    df["es_estrella"] = df["es_estrella"].astype(int)
...
st.caption(
    ...
    "precios, competencia y variables temporales (mes, trimestre, día del mes)."
)
